...
do{
    ...
    if (opcion == 2) {
        ...
        if (pedir == 1) {
            if (menu[0].stock > 0) {
                alert('Su pedido es: ' + menu[0].nombre + ' vale ' + menu[0].precio);
                menu[0].stock--;
        ...
        if (pedir == 2) {
            if (menu[1].stock > 0) {
                alert('Su pedido es: ' + menu[1].nombre + ' vale ' + menu[1].precio);
                menu[1].stock--;
        ...
        if (pedir == 3) {
            if (menu[2].stock > 0) {
                alert('Su pedido es: ' + menu[2].nombre + ' vale ' + menu[2].precio);
                menu[2].stock--;
